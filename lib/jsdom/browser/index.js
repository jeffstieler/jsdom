...
exports.DOMWindow = function (dom, options) {
	...
	this.clearInterval = exports.DOMWindow.prototype.stopTimer;
	this.clearTimeout = exports.DOMWindow.prototype.stopTimer;
	this.__stopAllTimers = exports.DOMWindow.prototype.stopAllTimers;
}

exports.DOMWindow.prototype = {
...
exports.createWindow = function(dom, options) {
  ...
  var window = new exports.DOMWindow(dom, options);
